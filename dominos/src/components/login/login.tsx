      ...
      <div className={style.login__outer}>
        <div className={style.login__inner}>
          ...
          <div className={style.login__form}>
            <button className={style.login__formClose} type="button">
              <span>
            ...
            <div className={style.login__formEdit}>
              ...
              <div className={style.login__formEditItem}>
                <label className={style.login__label} htmlFor="loginEMail">
                  Email
                  <input className={style.login__input} type="text" id="loginEMail" />
                </label>
              </div>
              <div className={style.login__formEditItem}>
                <label className={style.login__label} htmlFor="loginPass">
                  Пароль
                  <input className={style.login__input} type="password" id="loginPass" />
                </label>
              </div>
              <button className={style.login__btn} type="button">Boйти</button>
              <div>
                <a className={style.login__formEditLink} href="https://dominos.by/">
                  Забыли пароль?
                </a>
              </div>
              <div>
